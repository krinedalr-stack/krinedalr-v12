    ...
    <main>
      ...
      <section className="section">
        <div className="container reviews-grid">
          ...
          <article className="card review-card">
            <p className="review-text">“We had a roof leak in heavy rain, Chris arrived close to 3Am In The midnight, to make the house safe. Snow, rain and storm didn&apos;t stop him. Thrust 100% saved number - Compleated, insurance claim report was issued with couple hours ,Cant imagene better service,To be honest only number to answer my phone call on Real Emergancy. Thank you Chris.”</p>
